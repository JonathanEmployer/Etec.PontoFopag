...
namespace RegistradorPontoWeb.Models.Ponto
{
    ...
    public partial class IdentificacaoReconhecimentoFacil
    {
        ...
        public Nullable<int> IdRegistroPontoTentativa { get; set; }
        public Nullable<int> IdRegistroPonto { get; set; }
        public string FaceAttributesJson { get; set; }
        public Nullable<double> Confidence { get; set; }
        public Nullable<bool> IsIdentical { get; set; }
        public string NomeArquivoFoto { get; set; }
    
        public virtual RegistroPonto RegistroPonto { get; set; }
        public virtual RegistroPontoTentativa RegistroPontoTentativa { get; set; }
    }
}
