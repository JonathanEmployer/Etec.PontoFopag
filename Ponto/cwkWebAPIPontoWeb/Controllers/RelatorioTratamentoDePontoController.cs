...
namespace cwkWebAPIPontoWeb.Controllers
{
    public class RelatorioTratamentoDePontoController : ApiController
    {
        ...
        [Authorize]
        [TratamentoDeErro]
        public HttpResponseMessage RelatorioTratamentoDePonto(RelatorioTratamentoDePontoParam parametros)
        {
            ...
            try
            {
                ...
                if (ModelState.IsValid)
                {
                    ...
                    List<Modelo.Proxy.Relatorios.PxyRelatorioTratamentoDePonto> listRel = bllTratamentoDePonto.GetDadosRelatorio(idsFuncs.ToList(), DateTime.Parse(parametros.InicioPeriodo), DateTime.Parse(parametros.FimPeriodo)).ToList();
