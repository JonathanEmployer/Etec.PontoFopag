...
{
    public class RelatorioCartaoPontoExecaoHTMLController : Controller
    {
        #region Métodos Get
        // GET: RelatorioAfastamento
        public ActionResult CartaoPontoExcecaoHtml()
        {
            ...
            IList<pxyCartaoPontoEmployer> cps = bllCartaoPonto.BuscaDadosRelatorioPontoExcecao(funcs, di, df, null,0, true);
        ...
        public ActionResult CartaoPonto()
        {
            ...
            return View("~/Views/RelatorioCartaoPontoHTML/CartaoPonto.cshtml",viewModel);
        }
        #endregion
        #region Métodos Post
        [HttpPost]
        ...
        private byte[] Impressao(DateTime dataIni, DateTime dataFin, IList<int> funcs)
        {
            ...
            UsuarioPontoWeb pw = Usuario.GetUsuarioPontoWebLogadoCache();
            BLL.CartaoPontoV2 bllCartaoPonto = new BLL.CartaoPontoV2(conn, pw);
            IList<pxyCartaoPontoEmployer> cps = bllCartaoPonto.BuscaDadosRelatorioPontoExcecao(funcs, dataIni, dataFin, null, 0, true);
        ...
        private ActionResult GeraRelCartaoPonto(RelatorioCartaoPontoHTMLModel parms)
        {
            try
            {
                ...
                Modelo.Proxy.PxyJobReturn ret = hfm.RelatorioCartaoPontoExcecaoHTML(parms);
