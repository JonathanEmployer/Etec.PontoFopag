...
(function ($, window, document, undefined) {
    ...
    $form.submit(function (e) {
        ...
        var formData = {
            ...
            'telefone' : $('input[name="form-telefone"]').val(),
        ...
        $.ajax({
            type : 'POST',
            url  : '/Content/Landing/process.php',
            data : formData,
            dataType : 'json',
            encode : true
        }).done(function (data) {
            ...
            if (!data.success) {
                ...
                if (data.errors.telefone) {
                    $('#telefone-field').addClass('has-error');
                    $('#telefone-field').find('.col-lg-10').append('<span class="help-block">' + data.errors.subject + '</span>');
                }
