...
namespace Modelo.Proxy
{
    public class pxyFuncionarioRelatorio : ModeloBase
    {
        ...
        [TableHTMLAttribute("Pessoa Supervisor", 6, true, ItensSearch.select, OrderType.none)]
        ...
        [TableHTMLAttribute("Alocação", 7, true, ItensSearch.select, OrderType.none)]
        ...
        [TableHTMLAttribute("Horário", 9, true, ItensSearch.select, OrderType.none)]
    ...
    {
        [TableHTMLAttribute("Ativo", 10, true, ItensSearch.select, OrderType.none)]
        public String Ativo
        {
            get
            {
