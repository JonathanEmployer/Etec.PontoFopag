...
{
    public class MDREPPrintPointLi : DimepPrintPoint
    {
        protected override void InstanciaWatchComm()
        {
            ...
            _watchComm = new WatchComm(WatchProtocolType.PrintPointLi, comm, 1, accessKey, WatchConnectionType.ConnectedMode, "");
        }
    }
}
