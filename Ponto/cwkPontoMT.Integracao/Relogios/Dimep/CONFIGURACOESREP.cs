...
namespace cwkPontoMT.Integracao.Relogios.Dimep
{
    ...
    public partial class CONFIGURACOESREP
    {
        public int IDCONFIGURACAOREP { get; set; }
        ...
        public Nullable<short> NDIGITOSEXIBICAOCREDENCIAL { get; set; }
        public Nullable<bool> HABILITALEMATRICULAHEXA { get; set; }
        public Nullable<bool> RECONHECIMENTOBIOMETRICO180 { get; set; }
