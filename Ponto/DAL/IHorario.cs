...
namespace DAL
{
    public interface IHorario : DAL.IDAL
    {
        ...
        List<Modelo.Horario> GetHorarioNormalMovelList(int tipoHorario);
        ...
        List<Modelo.Horario> GetAllList(bool carregaHorarioDetalhe, bool carregaPercentuais, int tipohorario);
