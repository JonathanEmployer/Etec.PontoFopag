...
namespace TesteProgramacao
{
    ...
    class testes
    {
        ...
        public void metodoGenericoCTRL(bool teste)
        {
            ...
            connectionString = @"Data Source=empvw02210\hom308;initial catalog=CentralCliente;user id=pontofopag_app;password=123;Application Name=cwkpontoweb;MultipleActiveResultSets=true;Asynchronous Processing=true";
