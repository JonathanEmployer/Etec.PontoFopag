...
namespace BLL_N.JobManager.Hangfire
{
    public class HangfireManagerImportacoes : HangfireManagerBase
    {
        ...
        public Modelo.Proxy.PxyJobReturn ImportarArquivoAFD(IList<REP> listaReps, DateTime? dataInicial, DateTime? dataFinal, FileInfo arquivo, bool pIndividual, string dsCodFuncionario , bool? bRazaoSocial)
        {
            ...
            string idJob = new BackgroundJobClient().Create<ImportacoesJob>(x => x.ImportacaoAFD(null, jobControl, listaReps, dataInicial, dataFinal, arquivo, pIndividual, dsCodFuncionario, dataBase, usuarioLogado, bRazaoSocial), _enqueuedStateNormal);
