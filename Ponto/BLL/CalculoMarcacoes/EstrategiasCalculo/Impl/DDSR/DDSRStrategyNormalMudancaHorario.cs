...
{
    public class DDSRStrategyNormalMudancaHorario : DDSRStrategyAbstract, IDDSRStrategy
    {
        public DDSRStrategyNormalMudancaHorario(IEnumerable<DataRow> marcacoes, Dictionary<int, Modelo.Horario> horariosDasMarcacoes, string connectionString)
        ...
        {
            return "Normal-Mudança de Horário";
        }
    }
}
