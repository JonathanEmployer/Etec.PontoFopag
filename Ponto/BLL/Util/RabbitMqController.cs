...
namespace BLL.Util
{
    public class RabbitMqController : IDisposable
    {
        ...
        private const string Queue_Fechamento = "Pontofopag_Fechamento";
        ...
        #region SendFechamentoIntegration
        public void SendFechamentoIntegration(MessageIntegrationDto MessageIntegration)
        {
            SendMessage(Queue_Fechamento, JsonConvert.SerializeObject(MessageIntegration));
        }
        #endregion
