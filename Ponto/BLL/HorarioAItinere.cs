...
namespace BLL
{
    public class HorarioAItinere : IBLL<Modelo.HorarioAItinere>
    {
        DAL.IHorarioAItinere dalHorarioAItinere;
        private string ConnectionString;
        private Modelo.Cw_Usuario UsuarioLogado;

        public HorarioAItinere() : this(null)
        {
        ...
        public HorarioAItinere(string connString)
            : this(connString, cwkControleUsuario.Facade.getUsuarioLogado)
        {

        }

        public HorarioAItinere(string connString, Modelo.Cw_Usuario usuarioLogado)
        {
            ...
            {
                case 1:
                    dalHorarioAItinere = new DAL.SQL.HorarioAItinere(new DataBase(ConnectionString));
                    break;
            }
        ...
        {
            return dalHorarioAItinere.MaxCodigo();
        }

        public DataTable GetAll()
        {
            return dalHorarioAItinere.GetAll();
        }

        public Modelo.HorarioAItinere LoadObject(int id)
        {
            return dalHorarioAItinere.LoadObject(id);
        }

        public List<Modelo.HorarioAItinere> LoadPorHorario(int idHorario)
        {
            return dalHorarioAItinere.LoadPorHorario(idHorario);
        }

        public Dictionary<string, string> ValidaObjeto(Modelo.HorarioAItinere objeto)
        {
            Dictionary<string, string> ret = new Dictionary<string, string>();
            return ret;
        }

        public Dictionary<string, string> Salvar(Modelo.Acao pAcao, Modelo.HorarioAItinere objeto)
        {
            ...
            if (erros.Count == 0)
            {
                switch (pAcao)
                {
                    case Modelo.Acao.Incluir:
                        dalHorarioAItinere.Incluir(objeto);
                        break;
                    case Modelo.Acao.Alterar:
                        dalHorarioAItinere.Alterar(objeto);
                        break;
                    case Modelo.Acao.Excluir:
                        dalHorarioAItinere.Excluir(objeto);
                        break;
                }
            }
            return erros;
        ...
        {
            return dalHorarioAItinere.getId(pValor, pCampo, pValor2);
        }
        ...
        //{
        //    DataTable dt = dalHorarioAItinere.GetPercentualHoraExtra(dataInicial, dataFinal, empresas, departamentos, funcionarios, tipo);
        ...
        //    {
        //        objTotalHoras = new Modelo.TotalHoras();
        ...
        //    if (bDepartamento)
        //    {
        //        dt = dalHorarioAItinere.GetPercentualHoraExtraDepartamento(dataInicial, dataFinal, empresas, departamentos, funcionarios, tipo);
        //    }
        //    else
        //    {
        //        dt = dalHorarioAItinere.GetPercentualHoraExtra(dataInicial, dataFinal, empresas, departamentos, funcionarios, tipo);
        //    }
