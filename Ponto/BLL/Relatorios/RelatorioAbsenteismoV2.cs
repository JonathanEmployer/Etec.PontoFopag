...
namespace BLL.Relatorios
{
    public class RelatorioAbsenteismoV2
    {
        ...
        private static void Agrupamento(SpreadsheetGear.IRange cells, int linha, int iniConjunto, DataRow registro, string nomeGrupo, ref List<int> linhasGrupos)
        {
            ...
            cells[linha, coluna].Font.Bold = true;
            cells[linha, coluna++].Value = FormulaSoma(iniConjunto, linha, "I"); //registro["HorasTrabalhadas"].ToString();
            cells[linha, coluna].Font.Bold = true;
            cells[linha, coluna++].Value = FormulaSoma(iniConjunto, linha, "J"); //registro["NdeDiasTrab"].ToString();
            cells[linha, coluna].Font.Bold = true;
            cells[linha, coluna++].Value = registro["PercTrabalhado"].ToString().Replace("**", (linha + 1).ToString());
            cells[linha, coluna].Font.Bold = true;
            cells[linha, coluna++].Value = registro["PercAbsent"].ToString().Replace("**", (linha + 1).ToString());
            ...
            cells[linha, coluna++].Value = registro["PercHorasExtras"].ToString().Replace("**", (linha + 1).ToString());
            cells[linha, coluna].Font.Bold = true;
            cells[linha, coluna++].Value = FormulaSoma(iniConjunto, linha, "P"); //registro["AbonoLegal"].ToString();
            cells[linha, coluna].Font.Bold = true;
            cells[linha, coluna++].Value = FormulaSoma(iniConjunto, linha, "Q"); //registro["qtdAbonoLegal"].ToString();
            cells[linha, coluna].Font.Bold = true;
            cells[linha, coluna++].Value = registro["PercAbonoLegal"].ToString().Replace("**", (linha + 1).ToString());
            cells[linha, coluna].Font.Bold = true;
            cells[linha, coluna++].Value = FormulaSoma(iniConjunto, linha, "S"); //registro["AbonoNaoLegalOutros"].ToString();
            cells[linha, coluna].Font.Bold = true;
            cells[linha, coluna++].Value = FormulaSoma(iniConjunto, linha, "T"); //registro["qtdAbonoNaoLegalOutros"].ToString();
            cells[linha, coluna].Font.Bold = true;
            cells[linha, coluna++].Value = registro["PercAbonoNaoLegalOutros"].ToString().Replace("**", (linha + 1).ToString());
            cells[linha, coluna].Font.Bold = true;
            cells[linha, coluna++].Value = FormulaSoma(iniConjunto, linha, "V"); //registro["falta"].ToString();
            cells[linha, coluna].Font.Bold = true;
            cells[linha, coluna++].Value = FormulaSoma(iniConjunto, linha, "W"); //registro["qtdfalta"].ToString();
            cells[linha, coluna].Font.Bold = true;
            cells[linha, coluna++].Value = registro["Percfalta"].ToString().Replace("**", (linha + 1).ToString());
            cells[linha, coluna].Font.Bold = true;
            cells[linha, coluna++].Value = FormulaSoma(iniConjunto, linha, "Y"); //registro["Atrasos"].ToString();
            cells[linha, coluna].Font.Bold = true;
            cells[linha, coluna++].Value = FormulaSoma(iniConjunto, linha, "Z"); //registro["qtdAtrasos"].ToString();
            cells[linha, coluna].Font.Bold = true;
            cells[linha, coluna++].Value = registro["PercAtrasos"].ToString().Replace("**", (linha + 1).ToString());
            cells[linha, coluna++].Value = FormulaSoma(iniConjunto, linha, "AB"); //registro["CreBH"].ToString();
            cells[linha, coluna].Font.Bold = true;
            cells[linha, coluna++].Value = FormulaSoma(iniConjunto, linha, "AC"); //registro["QtdCreBH"].ToString();
            cells[linha, coluna].Font.Bold = true;
            cells[linha, coluna++].Value = registro["PercCreBH"].ToString().Replace("**", (linha + 1).ToString());
            cells[linha, coluna++].Value = FormulaSoma(iniConjunto, linha, "AE"); //registro["DebBH"].ToString();
            cells[linha, coluna].Font.Bold = true;
            cells[linha, coluna++].Value = FormulaSoma(iniConjunto, linha, "AF"); //registro["qtdDebBH"].ToString();
            cells[linha, coluna].Font.Bold = true;
            cells[linha, coluna++].Value = registro["PercDebBH"].ToString().Replace("**", (linha + 1).ToString());
        ...
        private static void TotalizadorGeral(SpreadsheetGear.IRange cells, int linha, DataRow registro, string nomeGrupo, List<int> grupos)
        {
            ...
            cells[linha, coluna].Font.Bold = true;
            cells[linha, coluna++].Formula = FormulaSomaGrupo(grupos, "J"); //registro["NdeDiasTrab"].ToString();
            cells[linha, coluna].Font.Bold = true;
            ...
            cells[linha, coluna].Font.Bold = true;
            cells[linha, coluna++].Formula = FormulaSomaGrupo(grupos, "P"); //registro["AbonoLegal"].ToString();
            cells[linha, coluna].Font.Bold = true;
            cells[linha, coluna++].Formula = FormulaSomaGrupo(grupos, "Q"); //registro["qtdAbonoLegal"].ToString();
            cells[linha, coluna].Font.Bold = true;
            cells[linha, coluna++].Formula = registro["PercAbonoLegal"].ToString().Replace("**", (linha + 1).ToString());
            cells[linha, coluna].Font.Bold = true;
            cells[linha, coluna++].Formula = FormulaSomaGrupo(grupos, "S"); //registro["AbonoNaoLegalOutros"].ToString();
            cells[linha, coluna].Font.Bold = true;
            cells[linha, coluna++].Formula = FormulaSomaGrupo(grupos, "T"); //registro["qtdAbonoNaoLegalOutros"].ToString();
            cells[linha, coluna].Font.Bold = true;
            cells[linha, coluna++].Formula = registro["PercAbonoNaoLegalOutros"].ToString().Replace("**", (linha + 1).ToString());
            cells[linha, coluna].Font.Bold = true;
            cells[linha, coluna++].Formula = FormulaSomaGrupo(grupos, "V"); //registro["falta"].ToString();
            cells[linha, coluna].Font.Bold = true;
            cells[linha, coluna++].Formula = FormulaSomaGrupo(grupos, "W"); //registro["qtdfalta"].ToString();
            cells[linha, coluna].Font.Bold = true;
            cells[linha, coluna++].Formula = registro["Percfalta"].ToString().Replace("**", (linha + 1).ToString());
            cells[linha, coluna].Font.Bold = true;
            cells[linha, coluna++].Formula = FormulaSomaGrupo(grupos, "Y"); //registro["Atrasos"].ToString();
            cells[linha, coluna].Font.Bold = true;
            cells[linha, coluna++].Formula = FormulaSomaGrupo(grupos, "Z"); //registro["qtdAtrasos"].ToString();
            cells[linha, coluna].Font.Bold = true;
            cells[linha, coluna++].Formula = registro["PercAtrasos"].ToString().Replace("**", (linha + 1).ToString());

            cells[linha, coluna++].Value = FormulaSomaGrupo(grupos, "AB"); //registro["CreBH"].ToString();
            cells[linha, coluna].Font.Bold = true;
            cells[linha, coluna++].Value = FormulaSomaGrupo(grupos, "AC"); //registro["QtdCreBH"].ToString();
            cells[linha, coluna].Font.Bold = true;
            cells[linha, coluna++].Value = registro["PercCreBH"].ToString().Replace("**", (linha + 1).ToString());
            cells[linha, coluna++].Value = FormulaSomaGrupo(grupos, "AE"); //registro["DebBH"].ToString();
            cells[linha, coluna].Font.Bold = true;
            cells[linha, coluna++].Value = FormulaSomaGrupo(grupos, "AF"); //registro["qtdDebBH"].ToString();
            cells[linha, coluna].Font.Bold = true;
            cells[linha, coluna++].Value = registro["PercDebBH"].ToString().Replace("**", (linha + 1).ToString());
        }
        #endregion
