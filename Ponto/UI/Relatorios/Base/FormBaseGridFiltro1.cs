...
{
    public partial class FormBaseGridFiltro1 : UI.Relatorios.Base.FormBaseSemEmpresa
    {
        protected List<Modelo.Empresa> listaEmpresas;
        protected List<int> listaRowHandleEmpresa;

        protected BLL.Empresa bllEmpresa;
        protected Modelo.Empresa objEmpresa;

        protected List<Modelo.Departamento> listaDepartamentos;
        protected List<int> listaRowHandleDepartamento;

        protected BLL.Departamento bllDepartamento;
        protected Modelo.Departamento objDepartamento;

        protected List<Modelo.Funcionario> listaFuncionarios;
        protected List<int> listaRowHandleFuncionario;

        protected BLL.Funcionario bllFuncionario;
        protected Modelo.Funcionario objFuncionario;
        ...
        public FormBaseGridFiltro1()
        {
            ...
            listaEmpresas = new List<Modelo.Empresa>();
            listaDepartamentos = new List<Modelo.Departamento>();
            listaFuncionarios = new List<Modelo.Funcionario>();

            listaRowHandleEmpresa = new List<int>();
            listaRowHandleDepartamento = new List<int>();
            listaRowHandleFuncionario = new List<int>();
        ...
        private static void SetValorCampoFiltro(XmlNode filtros, Control campo)
        {
        ...
        private static void SalvaValorCampoXml(XmlDocument documentoXml, XmlElement element, Control campo)
        {
            XmlElement c;
